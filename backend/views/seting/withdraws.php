...
$this->title = 'Системы для вывода средств';
...
<div class="row">
    ...
    <div class="col-lg-8">
        <?= $this->render('_menu') ?>
        <span style="font-size: 11px">*Комиссии: обычная / для верифицированных пользователей</span>
        <hr>
        <ul id="sortable">
            <?php
            $i = 1;
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <?= $currency->synonym ?></b><br>
                                    Мин/макс: <b><?= $system->sum_min ?>$ / <?= $system->sum_max ?>$</b><br>
                                    Коммисия*: <b><?= $system->fee ?>% / <?= $system->fee_verified ?>%</b><br>
                                </div>
                                <div class="col-sm-2">
                                    <a href="/seting/withdraw/<?= $system->id ?>">Настройки</a>
                                </div>
                                <div class="col-sm-2">
